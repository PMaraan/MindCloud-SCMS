    ...
    <form method="post" action="<?= BASE_PATH ?>/dashboard?page=courses&action=edit" class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-0 mt-3">
          ...
          <select id="edit-professor_ids" name="professor_ids[]" class="form-select" multiple size="6">
          ...
          <div class="form-text">Hold Ctrl/Cmd (or Shift) to assign multiple professors.</div>
        </div>
        <?php endif; ?>
      </div>
