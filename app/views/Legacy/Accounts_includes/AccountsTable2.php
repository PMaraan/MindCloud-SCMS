    ...
    <table class="table account-table table-bordered table-hover">
        ...
        <tbody id="table-body">
            ...
            //try {
                ...
                $canEdit = $canEditAccount['success'] === true && $canEditAccount['hasPermission'] === true;
                
                // check if account has delete permission
                $canDeleteAccount = $db->checkPermission('AccountDeletion');
                $canDelete = $canDeleteAccount['success'] === true && $canDeleteAccount['hasPermission'] === true;
