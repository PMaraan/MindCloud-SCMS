...
export function showFlashMessage(message = '', level = 'info') {
  let container = document.getElementById('sy-flash-container');
  if (!container) {
    container = document.createElement('div');
    container.id = 'sy-flash-container';
  ...
  const variant = level === 'danger' ? 'danger' : level === 'success' ? 'success' : 'secondary';
